...
In Area 1, you invite users by logging in to the Area 1 portal and inviting members. Refer to [Add user](/email-security/account-setup/manage-account-members/#add-user) for detailed instructions.  

To invite users in Email Security:

1. Log in to [Zero Trust](https://one.dash.cloudflare.com/).
2. Go to **Manage Account**.
3. Select **Members** > **Invite**. Refer to [Add account members](/fundamentals/setup/manage-members/manage/#add-account-members) for detailed instructions.

Once you have added new account members, you will have to assign each member a role. Refer to [Email Security roles](/cloudflare-one/roles-permissions/#email-security-roles) for the list of Email Security roles.
...
In Email Security, webhooks are instead referred to as logs. You can enable [detection logs](/cloudflare-one/insights/logs/enable-logs/#enable-detection-logs) and/or [user action logs](/cloudflare-one/insights/logs/enable-logs/#enable-user-action-logs).
...
- [Raise a ticket](/support/contacting-cloudflare-support/#getting-help-with-an-issue) and enter the correct answers to the following questions:
...
In Area 1, you can check your metrics in your Home section. Additionally, Area 1 allows you to set up message retraction to move messages to specific folders. This is known as **retraction**.
...
| [Block list](/email-security/email-configuration/lists/block-list/)      | [Blocked senders](/cloudflare-one/email-security/detection-settings/blocked-senders/)       |
| [Trusted domains](/email-security/email-configuration/lists/trusted-domains/)  | [Trusted domains](/email-security/detection-settings/trusted-domains/)       |
...
| Team submission addresses            | [Team submission addresses](/cloudflare-one/email-security/email-monitoring/search-email/#team-submissions)     |
| User submission addressed            | [User submission addresses](/cloudflare-one/email-security/email-monitoring/search-email/#user-submissions)      |

## Business Email Compromise

| Area 1                          | Email Security         |
|---------------------------------|------------------------|
| [Business Email Compromise (BEC)](/email-security/email-configuration/enhanced-detections/business-email-compromise/) | [Impersonation registry](/cloudflare-one/email-security/detection-settings/impersonation-registry/) |

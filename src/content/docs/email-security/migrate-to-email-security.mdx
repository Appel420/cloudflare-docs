...
In Area 1, you can check metrics in your Home section. Refer to [Statistics overview](/email-security/reporting/statistics-overview/) for more information. Additionally, Area 1 allows you to set up message retraction to move messages to specific folders. This is known as **retraction**. Refer to [Retract settings](/email-security/email-configuration/retract-settings/) to learn more.

...
If you already use BYOIP with CDN, you might be able to skip this step. If you are using this guide to upgrade a few IPs from a Spectrum prefix to the CDN, consider the following:

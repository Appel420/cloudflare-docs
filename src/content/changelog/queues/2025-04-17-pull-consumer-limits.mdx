---
title: Improved rate limits for Queues Pull Consumers
...
Pulled messages can be acknowledged (and deleted), or marked to retry. Head over to the [pull consumer documentation](/queues/configuration/pull-consumers) to learn how to acknowledge messages, pull batches of messages, and setup multiple consumers.
